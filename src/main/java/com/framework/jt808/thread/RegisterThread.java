...
public class RegisterThread implements Runnable {
	...
	public RegisterThread(ConcurrentLinkedQueue<PackageData> msgQueue, LedMsgProcessService msgProcessService) {
	...
	void dealQueque(PackageData packageData) {
		if(packageData != null) {
			try {
				msgProcessService.processRegisterMsg(packageData);
			} catch (Exception e) {
